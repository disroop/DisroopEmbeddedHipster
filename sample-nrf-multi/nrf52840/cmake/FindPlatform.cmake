...
function(target_setup_runtime TARGET_NAME)
    ...
    target_link_directories(${TARGET_NAME} PUBLIC ${CONAN_INCLUDE_DIRS_PLATFORMNRF52840})
    target_link_options(${TARGET_NAME} PUBLIC -T ${CONAN_PLATFORMNRF52840_ROOT}/${LINKER_FILE})
